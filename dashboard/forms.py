...
class AddTaskForm(forms.Form):
	...
	description = forms.CharField(widget=TinyMCE(attrs={'width':'100%', 'cols': 80, 'rows': 80}, mce_attrs={'width': '100%'}))
	title = forms.CharField(max_length=128, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter task title here...'}))
...
class AddCommentForm(forms.Form):
	title = forms.CharField(max_length=128, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter comment title here...'}))
	description = forms.CharField(widget=TinyMCE(attrs={'width':'100%', 'cols': 80, 'rows': 80}, mce_attrs={'width': '100%'}))
